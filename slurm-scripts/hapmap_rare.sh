...
#bcftools view /group/jrigrp/Share/genotypes/MaizeHapMapV3.2.1/uplifted_APGv4/hmp321_agpv4_chr${chr}.vcf.gz -q 0.2[:minor] -O z -o datasets/hapmap/hapmap321_${chr}_commonalleles.vcf.gz
...
# Grab overlap between hapmap and Biogemma founders
#bcftools isec -n +2 -w1 $founderfile datasets/hapmap/hapmap321_${chr}_rarealleles.vcf.gz > datasets/hapmap/hapmap321_${chr}_biogemma_rare_alleles.vcf

#bgzip datasets/hapmap/hapmap321_${chr}_biogemma_rare_alleles.vcf
#tabix -p vcf datasets/hapmap/hapmap321_${chr}_biogemma_rare_alleles.vcf.gz
...
bcftools query -f '%ID\t%CHROM\t%POS\t%REF\t%ALT[\t%GT]\n' datasets/hapmap/hapmap321_${chr}_biogemma_rare_alleles.vcf.gz -o datasets/hapmap/chr${chr}_founder_rare_alleles.txt

# Get positions of overlap from biogemma file
bcftools query -f '%CHROM\t%POS\n' datasets/hapmap/hapmap321_${chr}_biogemma_rare_alleles.vcf.gz -o datasets/hapmap/chr${chr}_hapmap_biogemma_rare_allele_positions.txt


# Grab ref and alt allele from hapmap using positions file
bcftools query -R datasets/hapmap/chr${chr}_hapmap_biogemma_rare_allele_positions.txt -f '%ID\t%CHROM\t%POS\t%REF\t%ALT\n' datasets/hapmap/hapmap321_${chr}_rarealleles.vcf.gz -o datasets/hapmap/chr${chr}_hapmap_biogemma_rare_alleles_ref.txt
