...
X_list=readRDS(sprintf('phenotypes/bg%s_updated_genoprobs.rds',chr))
...
fwrite(all_gwas,sprintf('QTL/updated/Biogemma_chr%s_%s_x_%s_updated_founderprobs.txt',chr,pheno,env),row.names=F,quote=F,sep='\t')
