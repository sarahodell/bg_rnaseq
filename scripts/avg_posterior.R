...
rownames(r1)=r1$V1
r1=r1[,-1]
r1_probs=paste0('Factor',c(33 :n_k))
...
rownames(r2)=r2$V1
r2=r2[,-1]
r2_probs=paste0('Factor',c(30:n_k))
...
rownames(r3)=r3$V1
r3=r3[,-1]
r3_probs=paste0('Factor',c(33:n_k))
...
df$factor=f
fwrite(df,sprintf('eqtl/trans/%s_chrom_factor.txt',time),row.names=F,col.names=F,quote=F,sep=',')
fwrite(as.data.frame(factors),sprintf('eqtl/trans/%s_factors.txt',time),row.names=F,quote=F,col.names=F,sep=',')
...
rownames(r2)=r2$V1
r2=r2[,-1]
r2_probs=paste0('Factor',c(28:n_k))
...
rownames(r3)=r3$V1
r3=r3[,-1]
r3_probs=paste0('Factor',c(29:n_k))
