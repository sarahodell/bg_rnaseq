...
comparison1=fread('QTT/QTL_cis_eQTL_overlap.txt',data.table=F)
...
random_ten=function(pei){
	...
	draw=sample(seq(1,nrow(eqtl)),ndraws)
	subeqtl=eqtl[draw,]
	n=min(10,ndraws)
...
upperbound=all_perms %>% group_by(pei) %>% summarize(cutoff=quantile(perm_max_r,0.975))
...
unique(top10$Trait)
#[1] "Zm00001d042133" "Zm00001d042106" "Zm00001d042307" "Zm00001d042078"
#[5] "Zm00001d000636" "Zm00001d042263" "Zm00001d042143" "Zm00001d042140"
#[9] "Zm00001d042146"
...
unique(top10$Trait)
#[1] "Zm00001d011152" "Zm00001d010946" "Zm00001d011331" "Zm00001d011231"
#[5] "Zm00001d010975" "Zm00001d011036" "Zm00001d011067"
