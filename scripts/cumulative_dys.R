...
for(pheno in phenos){
	for(env in envs){
		...
		png(sprintf("QTT/%s_%s_cumul_totexp_pred.png",pheno,env),width=1600,height=600)
		print(prow)
		dev.off()
	}
}
...
for(pheno in phenos){
	for(env in envs){
		...
		prow=plot_grid(plotlist=plotlist,nrow=1,ncol=4,labels=c("T12","T18","T20","T27"))
		png(sprintf("QTT/%s_%s_cumul_totexp_lm.png",pheno,env),width=1600,height=600)
		print(prow)
		dev.off()
	}
}
...
for(pheno in phenos){
	for(env in envs){
		...
		prow=plot_grid(plotlist=plotlist,nrow=1,ncol=4,labels=c("T12","T18","T20","T27"))
		png(sprintf("QTT/%s_%s_cumul_zscore_pred.png",pheno,env),width=1600,height=600)
		print(prow)
		dev.off()
	}
}
...
for(pheno in phenos){
	for(env in envs){
		...
		prow=plot_grid(plotlist=plotlist,nrow=1,ncol=4,labels=c("T12","T18","T20","T27"))
		png(sprintf("QTT/%s_%s_cumul_zscore_lm.png",pheno,env),width=1600,height=600)
		print(prow)
		dev.off()
	}
}
